...
class SoccerViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if CLLocationManager.locationServicesEnabled()
        {
            ...
            let url = "https://maps.googleapis.com/maps/api/place/textsearch/json?query=soccer+fields+in+nyc&key=AIzaSyDvFkv2h6M4O1GSkR1xz_b2v5UU21Ps8zo"
                                    ...
                                    if(latlong.0.description == "location")
                                    {
                                        ...
                                        for name in oCandidate
                                        {
                                            if (name.0.description == "name")
                                            {
                                                ...
                                                marker.icon = UIImage(named: "soccer")
                                                print(parkName)
